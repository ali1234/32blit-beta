...
#define LCD_BACKLIGHT_EN_Pin GPIO_PIN_1
#define LCD_BACKLIGHT_EN_GPIO_Port GPIOE
#define LCD_SPI4_MOSI_Pin GPIO_PIN_2
...
#define USER_LEFT1_Pin GPIO_PIN_3
#define USER_LEFT1_GPIO_Port GPIOC
#define USER_RIGHT1_Pin GPIO_PIN_3
...
#define BUTTON_HOME_Pin GPIO_PIN_1
#define BUTTON_HOME_GPIO_Port GPIOC
